...
DEFINE('STRUCTURE_DOWNLOAD_AND_EXTRACT', false); 
DEFINE('STRUCTURE_CLEAN', false);
DEFINE('STRUCTURE_PARSE_N_INSERT', false); 

DEFINE('CONTENT_DOWNLOAD_AND_EXTRACT', false);
DEFINE('CONTENT_CLEAN', false);
